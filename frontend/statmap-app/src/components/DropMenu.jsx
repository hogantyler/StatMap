...
const DropMenu = () => {
    return (
        <div className="group absolute top-4 left-4 cursor-pointer z-50">
            ...
            <div className="flex items-center justify-center p-3 rounded-xl bg-gray-800 hover:bg-gray-700 transition-colors">
                <svg 
            ...
            {/* Dark Dropdown Menu */}
            <div className="invisible absolute mt-2 w-48 flex flex-col bg-gray-800 border border-gray-700 rounded-xl shadow-xl group-hover:visible transition-all">
