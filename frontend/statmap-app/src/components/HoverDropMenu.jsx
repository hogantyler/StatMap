...
const HoverDropMenu = () => {
  ...
  return (
    <div className="group absolute top-0 left-0 md:top-1 md:left-1 z-50">
      <FlyoutLink
        FlyoutContent={() => (
          <FlyoutContent
            onSignInClick={() =>
              handleOpenModal(
                <SignIn
                  onSignUpClick={() =>
                    handleOpenModal(<SignUp onModalClose={handleCloseModal} />)
                  }
            ...
            onAccountPageClick={() =>
              handleOpenModal(<AccountPage onModalClose={handleCloseModal} />)
            }
            onLeaderboardClick={() =>
...
const FlyoutContent = ({
  ...
  return (
    <div className="w-80 bg-zinc-900/95 backdrop-blur-md border border-white/10 p-4 shadow-xl text-white rounded-lg">
      <div className="mb-4">
        <h3 className="font-medium text-lg border-b border-white/10 pb-2 mb-3">
          STATMAP MENU
        </h3>
