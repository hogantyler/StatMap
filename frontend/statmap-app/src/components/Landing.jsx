...
const Landing = () => {
  ...
  return (
    ...
    >
      <HoverDropMenu onSignInClick={(e) => handleOpenModal(<SignIn onSignUpClick={(e) => handleOpenModal(<SignUp />)} onModalClose={handleCloseModal}/>)} onAccountPageClick={(e) => handleOpenModal(<AccountPage />)} onModalClose={handleCloseModal}/>
