...
const Login = () => {
    ...
    return (
        <div className="w-[21rem] p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
            <form className="space-y-6" onSubmit={handleSubmit}>
                <h5 className="text-xl font-medium text-black text-center">STATMAP SIGN IN</h5>
                <div>
